...
| **REFUGIUM** | `antar.viability` | competing-hazard cohort viability, robust refugia, climate-analogue matching |
| **AEGIS** | `antar.decision` | CVaR-robust portfolio optimisation (MILP via HiGHS) across the scenario/model/parameter ensemble, out-of-sample evaluator |
